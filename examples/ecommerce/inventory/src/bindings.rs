...
pub mod wruntime {
    pub mod db {
        ...
        pub mod database {
            ...
            impl ::core::fmt::Debug for PgValue {
                fn fmt(
                    &self,
                    f: &mut ::core::fmt::Formatter<'_>,
                ) -> ::core::fmt::Result {
                    match self {
                        PgValue::Null => f.debug_tuple("PgValue::Null").finish(),
                        PgValue::Boolean(e) => {
                            f.debug_tuple("PgValue::Boolean").field(e).finish()
                        }
                        PgValue::Int2(e) => {
                            f.debug_tuple("PgValue::Int2").field(e).finish()
                        }
                        PgValue::Int4(e) => {
                            f.debug_tuple("PgValue::Int4").field(e).finish()
                        }
                        PgValue::Int8(e) => {
                            f.debug_tuple("PgValue::Int8").field(e).finish()
                        }
                        PgValue::Float4(e) => {
                            f.debug_tuple("PgValue::Float4").field(e).finish()
                        }
                        PgValue::Float8(e) => {
                            f.debug_tuple("PgValue::Float8").field(e).finish()
                        }
                        PgValue::Text(e) => {
                            f.debug_tuple("PgValue::Text").field(e).finish()
                        }
                        PgValue::Bytea(e) => {
                            f.debug_tuple("PgValue::Bytea").field(e).finish()
                        }
                        PgValue::Timestamptz(e) => {
                            f.debug_tuple("PgValue::Timestamptz").field(e).finish()
                        }
                        PgValue::Date(e) => {
                            f.debug_tuple("PgValue::Date").field(e).finish()
                        }
                        PgValue::Time(e) => {
                            f.debug_tuple("PgValue::Time").field(e).finish()
                        }
                        PgValue::Numeric(e) => {
                            f.debug_tuple("PgValue::Numeric").field(e).finish()
                        }
                        PgValue::Uuid(e) => {
                            f.debug_tuple("PgValue::Uuid").field(e).finish()
                        }
                        PgValue::Jsonb(e) => {
                            f.debug_tuple("PgValue::Jsonb").field(e).finish()
                        }
                        PgValue::Oid(e) => {
                            f.debug_tuple("PgValue::Oid").field(e).finish()
                        }
                    }
                }
            }
                ...
                fn fmt(
                    ...
                    match self {
                        DbError::Connection(e) => {
                            f.debug_tuple("DbError::Connection").field(e).finish()
                        }
                        DbError::Query(e) => {
                            f.debug_tuple("DbError::Query").field(e).finish()
                        }
                    }
                }
            }
            ...
            unsafe impl _rt::WasmResource for Transaction {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "wruntime:db/database@0.2.0")]
                        unsafe extern "C" {
            ...
            pub fn query(
                ...
                unsafe {
                    ...
                    unsafe { wit_import8(ptr0.cast_mut(), len0, result6, len6, ptr7) };
            ...
            pub fn execute(sql: &str, params: &[PgValue]) -> Result<u64, DbError> {
                unsafe {
                    #[repr(align(8))]
                    struct RetArea(
                        [::core::mem::MaybeUninit<
                    ...
                    let result19 = match l9 {
                        ...
                        1 => {
                            let e = {
                                let l11 = i32::from(*ptr7.add(8).cast::<u8>());
                                let v18 = match l11 {
                                    0 => {
                                        let e18 = {
                                            let l12 = *ptr7
            ...
            impl Transaction {
                ...
                pub fn query(
                    ...
                    unsafe {
                        ...
                        #[link(wasm_import_module = "wruntime:db/database@0.2.0")]
                        unsafe extern "C" {
                            #[link_name = "[method]transaction.query"]
                            fn wit_import8(
                                _: i32,
                                _: *mut u8,
                                _: usize,
            ...
            impl Transaction {
                ...
                pub fn execute(
                    ...
                    unsafe {
                        ...
                        #[link(wasm_import_module = "wruntime:db/database@0.2.0")]
                        unsafe extern "C" {
                            #[link_name = "[method]transaction.execute"]
                            fn wit_import8(
                                _: i32,
                                _: *mut u8,
                                _: usize,
            ...
            pub fn begin_transaction() -> Result<Transaction, DbError> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
                        ...
                        0 => {
                            let e = {
                                let l3 = *ptr0
                                    .add(::core::mem::size_of::<*const u8>())
                                    .cast::<i32>();
                                unsafe { Transaction::from_handle(l3 as u32) }
                            };
                            Ok(e)
                        }
                        1 => {
    ...
    pub mod tracing {
        ...
        pub mod span {
            ...
            pub struct ActiveSpan {
                handle: _rt::Resource<ActiveSpan>,
            }
            impl ActiveSpan {
                #[doc(hidden)]
                pub unsafe fn from_handle(handle: u32) -> Self {
            ...
            unsafe impl _rt::WasmResource for ActiveSpan {
                #[inline]
                unsafe fn drop(_handle: u32) {
                    #[cfg(not(target_arch = "wasm32"))]
                    unreachable!();
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "wruntime:tracing/span")]
                        unsafe extern "C" {
                            #[link_name = "[resource-drop]active-span"]
                            fn drop(_: u32);
                        }
                        unsafe { drop(_handle) };
                    }
            ...
            impl ActiveSpan {
                ...
                pub fn set_attribute(&self, key: &str, value: &str) -> () {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "wruntime:tracing/span")]
                        unsafe extern "C" {
                            #[link_name = "[method]active-span.set-attribute"]
                            fn wit_import2(
                                _: i32,
                                _: *mut u8,
                                _: usize,
            ...
            impl ActiveSpan {
                ...
                pub fn record_event(
                    ...
                    unsafe {
                        ...
                        #[link(wasm_import_module = "wruntime:tracing/span")]
                        unsafe extern "C" {
                            #[link_name = "[method]active-span.record-event"]
                            fn wit_import5(
                                _: i32,
                                _: *mut u8,
                                _: usize,
            ...
            impl ActiveSpan {
                ...
                pub fn set_error(&self, message: &str) -> () {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "wruntime:tracing/span")]
                        unsafe extern "C" {
                            #[link_name = "[method]active-span.set-error"]
            ...
            pub fn start(name: &str) -> ActiveSpan {
                unsafe {
                    let vec0 = name;
                    let ptr0 = vec0.as_ptr().cast::<u8>();
                    let len0 = vec0.len();
                    ...
                    unsafe { ActiveSpan::from_handle(ret as u32) }
                }
            }
        }
    }
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:ecommerce:inventory@1.0.0:inventory:encoded world"
)]
#[doc(hidden)]
...
B!\x01p}\x01o\x02ww\x01q\x10\x04null\0\0\x07boolean\x01\x7f\0\x04int2\x01|\0\x04\
int4\x01z\0\x04int8\x01x\0\x06float4\x01v\0\x06float8\x01u\0\x04text\x01s\0\x05b\
ytea\x01\0\0\x0btimestamptz\x01x\0\x04date\x01z\0\x04time\x01x\0\x07numeric\x01s\
\0\x04uuid\x01\x01\0\x05jsonb\x01s\0\x03oid\x01y\0\x04\0\x08pg-value\x03\0\x02\x01\
r\x02\x04names\x05value\x03\x04\0\x06column\x03\0\x04\x01p\x05\x01r\x01\x07colum\
ns\x06\x04\0\x03row\x03\0\x07\x01q\x02\x0aconnection\x01s\0\x05query\x01s\0\x04\0\
\x08db-error\x03\0\x09\x04\0\x0btransaction\x03\x01\x01h\x0b\x01p\x03\x01p\x08\x01\
j\x01\x0e\x01\x0a\x01@\x03\x04self\x0c\x03sqls\x06params\x0d\0\x0f\x04\0\x19[met\
hod]transaction.query\x01\x10\x01j\x01w\x01\x0a\x01@\x03\x04self\x0c\x03sqls\x06\
params\x0d\0\x11\x04\0\x1b[method]transaction.execute\x01\x12\x01j\0\x01\x0a\x01\
@\x01\x04self\x0c\0\x13\x04\0\x1a[method]transaction.commit\x01\x14\x04\0\x1c[me\
thod]transaction.rollback\x01\x14\x01@\x02\x03sqls\x06params\x0d\0\x0f\x04\0\x05\
query\x01\x15\x01@\x02\x03sqls\x06params\x0d\0\x11\x04\0\x07execute\x01\x16\x01i\
\x0b\x01j\x01\x17\x01\x0a\x01@\0\0\x18\x04\0\x11begin-transaction\x01\x19\x03\0\x1a\
wruntime:db/database@0.2.0\x05\0\x01B\x0d\x04\0\x0bactive-span\x03\x01\x01h\0\x01\
@\x03\x04self\x01\x03keys\x05values\x01\0\x04\0![method]active-span.set-attribut\
e\x01\x02\x01o\x02ss\x01p\x03\x01@\x03\x04self\x01\x04names\x05attrs\x04\x01\0\x04\
\0\x20[method]active-span.record-event\x01\x05\x01@\x02\x04self\x01\x07messages\x01\
\0\x04\0\x1d[method]active-span.set-error\x01\x06\x01i\0\x01@\x01\x04names\0\x07\
\x04\0\x05start\x01\x08\x03\0\x15wruntime:tracing/span\x05\x01\x01B\x04\x04\0\x05\
error\x03\x01\x01h\0\x01@\x01\x04self\x01\0s\x04\0\x1d[method]error.to-debug-str\
ing\x01\x02\x03\0\x13wasi:io/error@0.2.6\x05\x02\x01B\x0a\x04\0\x08pollable\x03\x01\
...
\x02in\x04\0\x05\x04\0\x04poll\x01\x06\x03\0\x12wasi:io/poll@0.2.6\x05\x03\x02\x03\
\0\x02\x05error\x02\x03\0\x03\x08pollable\x01B(\x02\x03\x02\x01\x04\x04\0\x05err\
or\x03\0\0\x02\x03\x02\x01\x05\x04\0\x08pollable\x03\0\x02\x01i\x01\x01q\x02\x15\
...
si:io/streams@0.2.6\x05\x06\x02\x03\0\x04\x0doutput-stream\x01B\x05\x02\x03\x02\x01\
\x07\x04\0\x0doutput-stream\x03\0\0\x01i\x01\x01@\0\0\x02\x04\0\x0aget-stderr\x01\
\x03\x03\0\x15wasi:cli/stderr@0.2.6\x05\x08\x01B\x0a\x01o\x02ss\x01p\0\x01@\0\0\x01\
\x04\0\x0fget-environment\x01\x02\x01ps\x01@\0\0\x03\x04\0\x0dget-arguments\x01\x04\
\x01ks\x01@\0\0\x05\x04\0\x0binitial-cwd\x01\x06\x03\0\x1awasi:cli/environment@0\
.2.6\x05\x09\x01B\x03\x01j\0\0\x01@\x01\x06status\0\x01\0\x04\0\x04exit\x01\x01\x03\
\0\x13wasi:cli/exit@0.2.6\x05\x0a\x01B\x0f\x02\x03\x02\x01\x05\x04\0\x08pollable\
...
\x08\x04\0\x12subscribe-duration\x01\x0a\x03\0!wasi:clocks/monotonic-clock@0.2.6\
\x05\x0b\x02\x03\0\x08\x08duration\x02\x03\0\x04\x0cinput-stream\x01B\xc1\x01\x02\
\x03\x02\x01\x0c\x04\0\x08duration\x03\0\0\x02\x03\x02\x01\x0d\x04\0\x0cinput-st\
ream\x03\0\x02\x02\x03\x02\x01\x07\x04\0\x0doutput-stream\x03\0\x04\x02\x03\x02\x01\
\x04\x04\0\x08io-error\x03\0\x06\x02\x03\x02\x01\x05\x04\0\x08pollable\x03\0\x08\
...
handle\x01\x0d\x03\0\x20wasi:http/outgoing-handler@0.2.6\x05\x13\x01B\x05\x01p}\x01\
@\x01\x03lenw\0\0\x04\0\x10get-random-bytes\x01\x01\x01@\0\0w\x04\0\x0eget-rando\
m-u64\x01\x02\x03\0\x18wasi:random/random@0.2.6\x05\x14\x02\x03\0\x09\x10incomin\
g-request\x02\x03\0\x09\x11response-outparam\x01B\x08\x02\x03\x02\x01\x15\x04\0\x10\
...
ndle\x01\x06\x04\0\x20wasi:http/incoming-handler@0.2.6\x05\x17\x04\0#ecommerce:i\
nventory/inventory@1.0.0\x04\0\x0b\x0f\x01\0\x09inventory\x03\0\0\0G\x09producer\
