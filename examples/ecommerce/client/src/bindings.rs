...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:ecommerce:client@1.0.0:client:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7223] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xba7\x01A\x02\x01A#\x01\
B\x0d\x04\0\x0bactive-span\x03\x01\x01h\0\x01@\x03\x04self\x01\x03keys\x05values\
\x01\0\x04\0![method]active-span.set-attribute\x01\x02\x01o\x02ss\x01p\x03\x01@\x03\
\x04self\x01\x04names\x05attrs\x04\x01\0\x04\0\x20[method]active-span.record-eve\
nt\x01\x05\x01@\x02\x04self\x01\x07messages\x01\0\x04\0\x1d[method]active-span.s\
et-error\x01\x06\x01i\0\x01@\x01\x04names\0\x07\x04\0\x05start\x01\x08\x03\0\x15\
wruntime:tracing/span\x05\0\x01B\x04\x04\0\x05error\x03\x01\x01h\0\x01@\x01\x04s\
elf\x01\0s\x04\0\x1d[method]error.to-debug-string\x01\x02\x03\0\x13wasi:io/error\
@0.2.6\x05\x01\x01B\x0a\x04\0\x08pollable\x03\x01\x01h\0\x01@\x01\x04self\x01\0\x7f\
...
l\x01\x06\x03\0\x12wasi:io/poll@0.2.6\x05\x02\x02\x03\0\x01\x05error\x02\x03\0\x02\
\x08pollable\x01B(\x02\x03\x02\x01\x03\x04\0\x05error\x03\0\0\x02\x03\x02\x01\x04\
...
ndle\x01\x06\x04\0\x20wasi:http/incoming-handler@0.2.6\x05\x16\x04\0\x1decommerc\
e:client/client@1.0.0\x04\0\x0b\x0c\x01\0\x06client\x03\0\0\0G\x09producers\x01\x0c\
