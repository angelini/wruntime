...
| Public JSON-to-protobuf request transcoding with guest-owned JSON responses | [codegen coordinator](../../../examples/codegen/coordinator/src/lib.rs) | [nested generator](../../../examples/codegen/coordinator/build.rs), [public routes](../../../examples/codegen/run.sh), [migration](../../../examples/codegen/coordinator/migrations/V1__create_tables.sql) |

Run scripts: [ecommerce](../../../examples/ecommerce/run.sh), [stockmarket](../../../examples/stockmarket/run.sh), [codegen](../../../examples/codegen/run.sh), and the cross-node [Echo topology](../../../examples/multi-node/run.sh). Configured public aliases transcode supported request bodies to protobuf and leave responses unchanged; the codegen coordinator intentionally creates its JSON response in the guest.
